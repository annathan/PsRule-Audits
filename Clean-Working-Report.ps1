# Clean-Working-Report.ps1
# Generate a clean working Essential 8 report with proper data handling
...
Write-Host ""
Write-Host "🎯 Clean Working Essential 8 Report Generator" -ForegroundColor Cyan
Write-Host "   Real Data + Working Buttons + No Errors!" -ForegroundColor Gray
Write-Host ""
...
Write-Host "  📊 Summary: $TotalRules total, $PassedRules passed, $FailedRules failed" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "🔧 Generating clean working report..." -ForegroundColor Yellow
...
# Create the HTML report with clean JavaScript
$HtmlContent = @"
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Essential 8 Clean Working Report - $(Get-Date -Format 'yyyy-MM-dd')</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛡️ Essential 8 Clean Working Report</h1>
...
$HtmlContent += @"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Essential 8 Clean Report loaded successfully!');
...
# Save the report
$ReportFile = Join-Path $ReportDir "Essential8-Clean-Working-Report-$Timestamp.html"
$HtmlContent | Out-File -FilePath $ReportFile -Encoding UTF8

Write-Host ""
Write-Host "🎯 Clean Working Essential 8 report generated!" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "🌐 Opening clean working report..." -ForegroundColor Yellow

# Open the report
try {
    Start-Process $ReportFile
    Write-Host "🎉 Clean working Essential 8 report opened!" -ForegroundColor Green
    Write-Host "   All buttons work with your real data! 🚀" -ForegroundColor Gray
} catch {
